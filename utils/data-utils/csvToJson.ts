import { InfoTableServicesDay } from '@/interfaces/stores-interface';
...
export function convertCSVtoJSON(result: string | ArrayBuffer | null | undefined): InfoTableServicesDay[] {
  const workbook: XLSX.WorkBook = XLSX.read(result, { type: 'binary' })
  // almacena los datos obtenidos
  let data: InfoTableServicesDay[] = []
